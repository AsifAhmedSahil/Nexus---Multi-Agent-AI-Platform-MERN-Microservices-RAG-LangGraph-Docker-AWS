...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 h-screen w-[280px] shrink-0 border-r border-white/[0.06] bg-[#0d0f14] transition-transform duration-250 lg:static lg:flex lg:translate-x-0 ${
