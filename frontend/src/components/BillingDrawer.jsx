      ...
      {open && (
        <>
          ...
          >
            ...
            <div className="px-5 overflow-auto space-y-4 flex-1">
              <div className="rounded-xl border border-white/10 p-4">
                ...
                <button className="mt-4 w-full rounded-lg bg-indigo-600 hover:bg-indigo-700 py-2 text-white cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                onClick={()=>handleUpgrade("starter")}
                disabled={loadingPlan === "starter"}
                >
                  {loadingPlan === "starter" ? "Redirecting..." : "Upgrade"}
                </button>
              </div>
