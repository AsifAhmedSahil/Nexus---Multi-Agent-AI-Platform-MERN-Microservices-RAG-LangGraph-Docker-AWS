...
const PanelContent = ({
  ...
  return (
    <motion.div
      ...
      className="flex h-full border-1 border-white/[0.06] flex-col overflow-hidden shrink-0 w-[250px]"
    >
      <>
        {!collapsed ? (
      ...
      {mobileOpen && (
        <>
          ...
          <motion.div
            ...
            className="lg:hidden fixed inset-y-0 right-0 z-50 w-[88vw] max-w-[420px] border-l border-white/10 overflow-hidden"
          >
            <PanelContent
              artifacts={artifacts}
              collapsed={collapsed}
